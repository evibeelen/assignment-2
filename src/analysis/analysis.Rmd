...
Neg.Event <- by(dt$Negative, dt$Events, mean)
neu.Event <- by(dt$Neutral, dt$Events, mean)
pos.Event <- by(dt$Positive, dt$Events, mean)
comp.Event <- by(dt$Compound, dt$Events, mean)
for (value in Neg.Event){Negative.Event<-value}
for (value in neu.Event){Neutral.Event<-value}
for (value in pos.Event){Postive.Event<-value}
for (value in comp.Event){Compound.Event<-value}

Neg.soccer <- by(dt$Negative, dt$`Paid Soccer`, mean)
neu.soccer <- by(dt$Neutral, dt$`Paid Soccer`, mean)
pos.soccer <- by(dt$Positive, dt$`Paid Soccer`, mean)
comp.soccer <- by(dt$Compound, dt$`Paid Soccer`, mean)
...
Neg.sport <- by(dt$Negative, dt$Sports, mean)
neu.sport <- by(dt$Neutral, dt$Sports, mean)
pos.sport <- by(dt$Positive, dt$Sports, mean)
comp.sport <- by(dt$Compound, dt$Sports, mean)
