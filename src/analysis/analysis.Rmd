...
cat("Number of tweets about the contact-based profession Measures is", Contact, "\n")
cat("Number of tweets about the Nursing homes Measures is", Nursing, "\n")
cat("Number of tweets about the Hospitality Measures is", Hospitality, "\n")
cat("Number of tweets about the Event Measures is", Event, "\n")
cat("Number of tweets generally about the press conference is", General, "\n")
```
